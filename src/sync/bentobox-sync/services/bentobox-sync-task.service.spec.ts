...
describe('BentoboxSyncTaskService', () => {
    ...
    beforeEach(async () => {
        const moduleRef = await Test.createTestingModule({
            providers: [BentoboxSyncUtilsService, BentoboxSyncTaskService, BlockchainService, LoggerService, BentoboxSyncService, BentoboxEntityService],
        })
    ...
    describe('syncTask', () => {
        ...
        beforeEach(() => {
            ...
            updateOneMock = jest.spyOn(bentoboxEntityService, 'updateOne');
